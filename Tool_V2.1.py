...
:root {
  ...
  --r:        12px;
  /* Sidebar Dark Theme */
  --sidebar-grad-top: #07111C;
  --sidebar-grad-mid: #061521;
  --sidebar-grad-bottom: #040B14;
  --sidebar-border: rgba(0, 255, 255, 0.08);
  --sidebar-text-primary: #FFFFFF;
  --sidebar-text-secondary: rgba(255, 255, 255, 0.65);
  --sidebar-text-menu: rgba(255, 255, 255, 0.88);
  --sidebar-icon: rgba(255, 255, 255, 0.82);
  --sidebar-hover: rgba(255, 255, 255, 0.04);
  --sidebar-cyan: #00FFD0;
  --sidebar-cyan-glow: rgba(0, 255, 220, 0.8);
  --sidebar-cyan-light: rgba(0, 255, 220, 0.16);
  --sidebar-status-bg: #081520;
  --sidebar-status-border: rgba(0, 255, 255, 0.12);
  --sidebar-disconnect-border: rgba(255, 80, 80, 0.7);
  --sidebar-disconnect-text: #FF5A5A;
  --sidebar-disconnect-hover: rgba(255, 80, 80, 0.1);
}
...
body.light-theme {
  ...
  --sidebar-grad-mid: #F7F9FB;
  --sidebar-grad-bottom: #F7F9FB;
  --sidebar-border: #E5E7EB;
  --sidebar-text-primary: #0F172A;
  --sidebar-text-secondary: #64748B;
  --sidebar-text-menu: #1E293B;
  --sidebar-icon: #334155;
  --sidebar-hover: #F3F4F6;
  --sidebar-cyan: #00A38C;
  --sidebar-cyan-glow: rgba(0, 163, 140, 0.4);
  --sidebar-cyan-light: #EEF7F6;
  --sidebar-status-bg: #FFFFFF;
  --sidebar-status-border: #E5E7EB;
  --sidebar-disconnect-border: #FCA5A5;
  --sidebar-disconnect-text: #EF4444;
  --sidebar-disconnect-hover: #FEF2F2;
}
body {
...
/* ════════════════════════════════════════════════════════════ */
/* PREMIUM INDUSTRIAL TELEMETRY SIDEBAR */
/* ════════════════════════════════════════════════════════════ */
.sidebar {
  width: 260px;
  height: 100%;
  background: linear-gradient(180deg, var(--sidebar-grad-top) 0%, var(--sidebar-grad-mid) 50%, var(--sidebar-grad-bottom) 100%);
...
.logo-icon {
  ...
  height: 40px;
  border-radius: 10px;
  background: linear-gradient(135deg, rgba(0, 255, 220, 0.2), rgba(0, 255, 150, 0.1));
...
body.light-theme .logo-icon {
  background: linear-gradient(135deg, rgba(0, 163, 140, 0.1), rgba(0, 163, 140, 0.05));
  border: 1.5px solid rgba(0, 163, 140, 0.3);
}
...
.nav-item.active {
  background: linear-gradient(90deg, rgba(0, 255, 220, 0.16) 0%, rgba(0, 255, 220, 0.05) 100%);
  color: var(--sidebar-cyan);
}
...
.nav-item.active::before {
  ...
  box-shadow: 0 0 10px var(--sidebar-cyan-glow);
}
...
body.light-theme .sidebar-nav::-webkit-scrollbar-thumb {
  background: rgba(0, 163, 140, 0.15);
}
...
body.light-theme .sidebar-nav::-webkit-scrollbar-thumb:hover {
  background: rgba(0, 163, 140, 0.25);
}
...
.status-indicator {
  ...
  border-radius: 50%;
  background: var(--sidebar-cyan);
  box-shadow: 0 0 8px var(--sidebar-cyan-glow), 0 0 16px rgba(0, 255, 220, 0.4);
  flex-shrink: 0;
  animation: pulse-glow 2s ease-in-out infinite;
}

body.light-theme .status-indicator {
  box-shadow: 0 0 0 rgba(0, 163, 140, 0.4);
}

@keyframes pulse-glow {
  0%, 100% { box-shadow: 0 0 8px var(--sidebar-cyan-glow), 0 0 16px rgba(0, 255, 220, 0.4); }
  50% { box-shadow: 0 0 12px var(--sidebar-cyan-glow), 0 0 24px rgba(0, 255, 220, 0.6); }
}
...
body.light-theme .status-detail-label {
  color: var(--sidebar-text-secondary);
}
...
.disconnect-btn {
  flex: 1;
  height: 32px;
  border: 1px solid var(--sidebar-disconnect-border);
  background: transparent;
  color: var(--sidebar-disconnect-text);
  border-radius: 8px;
  font-size: 12px;
  font-weight: 600;
  cursor: pointer;
...
body.light-theme .disconnect-btn {
  border: 1px solid var(--sidebar-disconnect-border);
  color: var(--sidebar-disconnect-text);
}

.disconnect-btn:hover {
  background: var(--sidebar-disconnect-hover);
}
...
body.light-theme .sidebar-identity {
  border-bottom: 1px solid var(--sidebar-border);
}
...
<aside class="sidebar">
  ...
  <div class="sidebar-logo">
    ...
    <div class="logo-text">Throughput</div>
  </div>
  ...
  <nav class="sidebar-nav">
    <button class="nav-item active" onclick="sidebarSetActive(this, 'dashboard')">
    ...
    <button class="nav-item" onclick="sidebarSetActive(this, 'analysis')">
      <span class="nav-icon">📈</span>
      <span class="nav-label">Analysis</span>
    </button>
    <button class="nav-item" onclick="sidebarSetActive(this, 'reports')">
      <span class="nav-icon">📋</span>
      <span class="nav-label">Reports</span>
    </button>
    <button class="nav-item" onclick="sidebarSetActive(this, 'data-export')">
      <span class="nav-icon">💾</span>
      <span class="nav-label">Data Export</span>
    </button>
    <button class="nav-item" onclick="sidebarSetActive(this, 'settings')">
      <span class="nav-icon">⚙️</span>
    ...
    <div class="status-card">
      ...
      <div class="status-details">
        <div class="status-detail-item">
          ...
          <span class="status-detail-value" id="sidebarPort">—</span>
        </div>
        <div class="status-detail-item">
          <span class="status-detail-label">Baud Rate</span>
          <span class="status-detail-value" id="sidebarBaudRate">115200</span>
        </div>
      </div>
      <div class="status-timer">
        <span class="timer-label">Active Time</span>
        <span class="timer-value" id="sidebarTimer">00:00:00</span>
      </div>
      <div class="status-action">
        <button class="disconnect-btn" onclick="if(app) app.disconnectSerial()">Disconnect</button>
      </div>
    </div>
  </div>
</aside>
...
async function refreshPorts() {
  ...
  // ── Timer functions for active session tracking ───
  function startTimer() {
    elapsedSeconds = 0;
    updateTimerDisplay();
...
// Disable Enter and Space keys from triggering buttons
  ...
  // ════════════════════════════════════════════════════════════════════
  function sidebarSetActive(element, section) {
  ...
  // Update sidebar status with connection info
  function updateSidebarStatus() {
    const portEl = document.getElementById('sidebarPort');
    const timerEl = document.getElementById('sidebarTimer');
    
    if (portEl && selectedPort) {
      portEl.textContent = selectedPort;
    }
    
    if (timerEl && isConnected && sessionStartTime) {
  ...
  // Update sidebar status every second
  setInterval(updateSidebarStatus, 1000);
